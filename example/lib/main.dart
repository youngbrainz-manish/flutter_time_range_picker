      ...
      body: ListView(
        children: [
          ElevatedButton(
            onPressed: () async {
              TimeRange? result = await showTimeRangePicker(
                context: context,
                toFromStyle: const TextStyle(color: Colors.white, fontSize: 20),
                okButtonWidget: Container(
          ...
          ElevatedButton(
            onPressed: () {
              showTimeRangePicker(
                toFromStyle: TextStyle(color: Colors.red, fontSize: 10),
                context: context,
          ...
          const Divider(),
          Text('As a regular widget:', style: Theme.of(context).textTheme.titleLarge, textAlign: TextAlign.center),
          const SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [Text("Start: ${_startTime.format(context)}"), Text("End: ${_endTime.format(context)}")],
          ),
          SizedBox(
            height: 400,
